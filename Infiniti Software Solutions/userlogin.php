	...
	<head>
		...
		<div class="row">
			<div class="col-md-8" >
				...
				<img src="img/img12.jpg" class="img img-thumbnail" style="height:400px; width:100%; padding:10px">
				<div class="side">
					<div class="post_main">
						<span > Comment</span>
					</div>
				...
				<br>
					<form >
						...
						<input id="name" type="email" style="width:500px" name="name" required  class="form_control"><br>
						<label for="name" >Commet Me</label><br>
						<input id="name" type="text"  style="width:500px" name="name" required  class="form_control"><br>
